  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      'process.env': {
        ...
        STAGING: typeof process.env.STAGING === 'undefined' ? false : (process.env.STAGING === 'true'),
        GEOBLOCK: typeof process.env.GEOBLOCK === 'undefined' ? true : (process.env.GEOBLOCK === 'true')
      },
      __CLIENT__: true,
      __SERVER__: false,
